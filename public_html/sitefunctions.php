  ...
  if(!empty($_GET['log']))
  {
    ...
    if($log == 'out')
    {
      echo "<fieldset class='box center blue outline'>
       You have successfully logged out, super shopper! </fieldset>";
    }
    if($log == 'in')
    {
      echo "<fieldset class='box center blue outline'>
       You have successfully logged in, " . getUsername() . "! </fieldset>";
    }
    if($log == 'new')
    {
      echo "<fieldset class='box center blue outline'>
       You created the account " . getUsername() . ". <br>
       You are now logged in! </fieldset>";
    }
  }
}
...
function outputGreeting()
{
    if (userIsLoggedIn())
    {
        ...
        return "<span class='login outline'>Welcome $username!
            </span><a class='head' href=logout.php>LOG OUT</a>";
    }
    return "<span class='login outline'>Welcome Guest!
            </span><a class='head' href=login.php>LOG IN</a>";
}
...
function showAddMessage($pid, $quantity)
{
  ...
  echo "<fieldset class='box center blue outline'> You now have $quantity of the \"$name\" in your cart </fieldset>";
}
